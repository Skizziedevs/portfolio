  ...
  <div class="">
    ...
    >
      <div class="pt-[60px] my-auto md:flex-col-reverse">
        ...
        <img
          src="../../img/down.png"
          class="relative hidden md:block top-[172px]"
          alt=""
        />
      </div>
      <img
      ...
      <img
        src="../../img/buildlg.png"
        class="pt-[60px] ml-[86px] w-[600px] lg:block hidden"
        alt=""
      />
    </div>
    <div
    ...
    >
      ...
      >
        ...
        was not an easy time, but it was one hell of a ride.
      </p>
      ...
      <div class="space-y-[34px]">
        ...
        >
          ...
          like it was yesterday. The streets glittered and the skyscrapers were
          imposing. I felt myself taken aback by the intensity of the city.
          People darting to and from. I was lost but it was magnificent. I felt
        ...
        >
          ...
          Yards. It really did start to feel like a new chapter in my life had
          begun.
        </p>
        <p
          class="text-[#666] xlg:text-[24px] font-[Inter] font-[400] text-[14px] leading-[27px] md:text-[20px] md:leading-[30px]"
        ...
        >
          ...
          situation in Wuhan closely. I scoffed off concerns at first. After
        ...
        >
          ...
          had just met 3 months prior. Suddenly everyone went from smiling faces
          in person to tired expressions behind a screen.
        </p>
      </div>
      ...
      <div class="space-y-[34px]">
        ...
        >
          ...
          the ambulances blaring all night long. Each siren was just a reminder
        ...
        >
          ...
          subway. $1 Pizza Shops opening back up. But something felt different.
        </p>
      </div>
      <p
        class="font-[Inter] xlg:text-[24px] text-[20px] italic font-[400] leading-[27px] border-l-[2px] border-l-gray-400 md:text-[24px] md:leading-[34px] md:font-[500] pl-[25px] my-[40px]"
      ...
      <div class="space-y-[34px]">
        ...
        >
          ...
          when I coughed. The city is back, but I wasn't ready. And maybe I'll
          never be.
        </p>
        <p
          class="text-[#666] font-[Inter] xlg:text-[24px] font-[400] text-[14px] leading-[27px] md:text-[20px] md:leading-[30px]"
